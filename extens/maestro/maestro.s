...
playirq3:
		...
		move.b     (a3),d7
		subq.l     #1,length
		bmi.s      outofit2 /* BUG: should be beq */
		addq.l     #1,startaddr
intoit2:
		andi.w     #255,d7
		lea.l      voldat2,a3
...
playirq4:
		...
		move.b     (a3),d7
		subq.l     #1,length
		bmi.s      outofit3 /* BUG: should be beq */
		subq.l     #1,startaddr
intoit3:
		andi.w     #255,d7
		lea.l      voldat2,a3
...
playirq5:
		...
		move.b     (a3),d7
		subq.l     #1,length
		bmi.s      outofit4 /* BUG: should be beq */
		addq.l     #1,startaddr
intoit4:
		lea.l      voldat2,a3
		lsl.w      #4,d7
...
playirq6:
		...
		moveq.l    #7,d7
		move.b     (a3),d7
		subq.l     #1,length /* BUG: should be beq */
		bmi.s      outofit5
		subq.l     #1,startaddr
intoit5:
		lea.l      voldat2,a3
...
recirq:
		...
		rte
routofit:
		addq.l     #1,startaddr         ; start adress +1 BUG: we are already done
