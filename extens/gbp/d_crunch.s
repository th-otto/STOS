...
.rest:
	move.b	-(a5),-(a3)	; wieder herzustellen
	dbf	d0,.rest
.not_packed:
	movem.l	(sp)+,d0-a6
	unlk	a3
...
L021C:	MOVE    SR,D1
  	ANDI.W  #$2000,D1
  	BEQ.S   L021D
  	MOVE.W  $FFFF8240.l,2(A6) /* XXX */
  	BTST    #1,$FFFF8260.l /* XXX */
  	BNE.S   L021D
  	SWAP    D5
L021D:	CLR.W   D5
  	MOVE.W  -(A0),D6
