...
catalog:
	dc.w	lib2-lib1		; length of routine 1  (lights on)
...
init:
	lea	end(pc),a2		; load position of end into A2
	rts
...
atmk2:
	move.l	4(a0),d3		; Store file length
	bra.s	ret2			; Return

ic_2:
	move.l	8(a0),d3		; Store file length
	bra.s	ret2			; Return
...
.loop:
	move.w	#0,(a0)		; Clear 160 bytes of data
	move.w	#0,8(a0)
	move.w	#0,16(a0)
	move.w	#0,24(a0)
	move.w	#0,32(a0)
